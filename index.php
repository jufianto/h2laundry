        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">Order Dry Cleaning and </h2>
					<h2 class="section-heading">Laundry Online</h2>
                    <hr class="light">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>You Order</h3>
                        <p class="text-muted">Book a collection time online or with the app</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        <img src="img/Collect.jpg">
                        <h3>We Collect</h3>
                        <p class="text-muted">We'll bring a bag - you don't need to do anything</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>We Clean</h3>
                        <p class="text-muted">Our facilities are so good we guarantee you'll be satisifed</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>We Deliver</h3>
                        <p class="text-muted">We'll deliver back to you, anytime and anywhere</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <a href="img/1.jpg" class="portfolio-box">
                        ...
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="fa fa-search fa-3x sr-contact"></div>
                            </div>
                        </div>
                    </a>
                </div>
